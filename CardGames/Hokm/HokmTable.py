...
class HokmTable:
	...
	def rl_settings(self, reward=100, loss=0, round_r=0, round_l=0):
...
def card_states_on_table(table):
	...
	['C10'], new_states = [tb3]
	'''
	return [HokmSettings.TABLE_BY_1, HokmSettings.TABLE_BY_2, HokmSettings.TABLE_BY_3][-len(table):] if len(table) > 0 else []